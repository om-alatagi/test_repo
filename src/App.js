...
//             <h2 style={{ textAlign: "center" }}>Send Money</h2>
//             <input
//                 type="number"
//                 name="senderContact"
...
//                 style={{ width: "100%", marginBottom: "10px", padding: "8px" }}
//             />
//             <button onClick={sendMoney} style={{ width: "100%", padding: "10px", backgroundColor: "blue", color: "white", border: "none", cursor: "pointer", marginBottom: "20px" }}>
//                 Send Money
//             </button>

//             <h2 style={{ textAlign: "center" }}>Add Money</h2>
//             <input
//                 type="number"
//                 name="userId"
//                 placeholder="User ID"
...
//                 style={{ width: "100%", marginBottom: "10px", padding: "8px" }}
//             />
//             <button onClick={addMoney} style={{ width: "100%", padding: "10px", backgroundColor: "green", color: "white", border: "none", cursor: "pointer" }}>
//                 Add Money
//             </button>
//         </div>
//     );
